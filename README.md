...
<p align="center">
  <em>Genetic Algorithm: Evolving a Profitable Strategy</em><br>
  <img src="images/ga_fitness_evolution_equity_curve.jpg" width="700" alt="Genetic Algorithm Fitness Evolution Equity Curve">
</p>

<p align="center" style="max-width: 700px; margin: auto; text-align: left;">
This plot showcases the evolutionary optimization process in action. Each grey line represents the out-of-sample equity curve for a unique "individual"—a specific set of model features—as it's tested by the Genetic Algorithm. The underlying strategy is to initiate a 5-day long position in VIXY (ProShares VIX Short-Term Futures ETF) whenever the model's confidence level exceeds 60%. Across seven generations, the system explores a vast search space, culminating in the discovery of the single best-performing feature set, whose superior log-return profile is highlighted in red.
</p>
<p align="center">
